...
struct AITrainingStyleClassifier {
    ...
    private static var instructions: String {
        ...
        **Training Style Classification** — Determine how the user structures their sets by weight pattern.
        ...
        Be conservative — only classify when the data clearly supports it. Return null when uncertain.
        """
    }
