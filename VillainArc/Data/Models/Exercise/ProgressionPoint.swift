...
///
/// **Purpose:**
/// - Tracks weight, volume, and estimated 1RM for charting progression over time
...
///     print("\(point.date): \(point.weight) lbs, \(point.volume) total volume, \(point.estimated1RM) est. 1RM")
/// }
/// ```
@Model
final class ProgressionPoint {
    ...
    init(date: Date, weight: Double, volume: Double, estimated1RM: Double) {
        self.date = date
        self.weight = weight
        self.volume = volume
