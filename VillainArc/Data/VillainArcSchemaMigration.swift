...
enum VillainArcSchemaV3: VersionedSchema {
    // Public App Store schema for Villain Arc 1.2.2.
...
// V4 adds AppSettings.assumeTargetRPEOnComplete and
// AppSettings.prefersTargetReferenceWhenPlanned.
enum VillainArcSchemaV4: VersionedSchema {
    // Public App Store schema for Villain Arc 1.2.3.
