...
nonisolated func shouldUseFuzzySearch(queryTokens: [String]) -> Bool { queryTokens.contains { $0.count >= 3 } }
...
nonisolated func levenshteinDistance(between left: String, and right: String, maxDistance: Int) -> Int {
    ...
    if abs(leftChars.count - rightChars.count) > maxDistance { return maxDistance + 1 }
