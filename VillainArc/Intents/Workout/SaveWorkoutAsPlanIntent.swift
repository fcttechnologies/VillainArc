...
struct SaveWorkoutAsPlanIntent: AppIntent {
    ...
    static var parameterSummary: some ParameterSummary { Summary("Save \(\.$workout) as workout plan") }
...
enum SaveWorkoutAsPlanError: Error, CustomLocalizedStringResourceConvertible {
    ...
    var localizedStringResource: LocalizedStringResource {
        ...
        case .workoutAlreadyHasPlan: return "This workout is already linked to a workout plan."
        case .workoutIncomplete: return "Finish the workout before saving it as a plan."
        }
    }
}
