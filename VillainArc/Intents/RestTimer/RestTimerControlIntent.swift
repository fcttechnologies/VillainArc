...
enum RestTimerControlAction: String, AppEnum {
    ...
    static let caseDisplayRepresentations: [RestTimerControlAction: DisplayRepresentation] = [.pause: DisplayRepresentation(title: "Pause"), .resume: DisplayRepresentation(title: "Resume"), .stop: DisplayRepresentation(title: "Stop")]
...
struct RestTimerControlIntent: AppIntent {
    ...
    @Parameter(title: "Action") var action: RestTimerControlAction
