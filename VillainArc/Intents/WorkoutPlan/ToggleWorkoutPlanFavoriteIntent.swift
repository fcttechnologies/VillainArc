...
struct ToggleWorkoutPlanFavoriteIntent: AppIntent {
    ...
    static let diagCrumb: any DiagBreadcrumb = VACrumb.intentToggleWorkoutPlanFavorite
    ...
    static var parameterSummary: some ParameterSummary { Summary("Toggle favorite for \(\.$workoutPlan)") }
...
enum ToggleWorkoutPlanFavoriteIntentError: Error, CustomLocalizedStringResourceConvertible {
    ...
    var localizedStringResource: LocalizedStringResource {
        ...
        case .workoutPlanIncomplete: return "Only completed workout plans can be favorited."
        }
    }
}
