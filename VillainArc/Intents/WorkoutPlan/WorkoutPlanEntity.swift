...
extension WorkoutPlanEntity {
    init(workoutPlan: WorkoutPlan) {
        ...
        fullContent = WorkoutPlanFullContent(id: workoutPlan.id, title: workoutPlan.title, summary: workoutPlan.spotlightSummary, notes: workoutPlan.notes.isEmpty ? nil : workoutPlan.notes, exercises: exercises.map { exercise in
            WorkoutPlanFullContent.Exercise(index: exercise.index, name: exercise.name, notes: exercise.notes.isEmpty ? nil : exercise.notes, muscles: exercise.musclesTargeted.map(\.displayName), sets: exercise.sortedSets.map { set in
